...
// Check if item unit Selected before Add to Cart
document.querySelector('button').addEventListener("click", function (e) {
    const isChecked = [...document.querySelectorAll('input')].some(i => i.checked);

    if (!isChecked) {
        alert("Please select one item unit before adding to the cart.");
    }
    else
    {
